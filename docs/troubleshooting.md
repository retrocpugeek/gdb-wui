...
established by measurement: x86-64, MIPS64, ARM, AArch64 and PowerPC have a
rule, and on anything else stack locals show nothing at all. A guess there would read as a
